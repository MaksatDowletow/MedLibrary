...
## Клонирование сайта 24radiology.ru

Для зеркального копирования сайта в репозиторий добавлен скрипт:

```bash
./scripts/clone-24radiology.sh [папка_назначения]
```

По умолчанию файлы сохраняются в каталог `24radiology.ru`.
